...
#define CONTROL_Sys_PARAM_FRAME 29
// 0x1D System Parameter Frame
...
#define CITY_id 30000                                          //30000
#define Garage_ID "0100"                                        //1
#define Garage_id 1                                             //1
...
// For the web Host server 
#define CONTROL_TYPE_ReqIni 21                 //0x15
#define CONTROL_TYPE_ParamAck 4                //0x04
#define CONTROL_TYPE_AdjustTime 5              //0x05
#define CONTROL_TYPE_Sitting 29                 //0x1D
#define CONTROL_TYPE_ReCharge 27                 //0x1B
...
public:
	...
	static std::string calcChecksum_client(int length, int serial, int function1, int function2);
        ...
        static int calcChecksum_server_Number(int length, int serial, int function, int year, int month, int day, int hour);
        
        static int calcChecksum_client_Number(int length, int serial, int function1, int function2);
